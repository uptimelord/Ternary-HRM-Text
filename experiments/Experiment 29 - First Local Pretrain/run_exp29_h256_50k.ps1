...
& rtk python -u "experiments/Experiment 29 - First Local Pretrain/first_local_pretrain.py" `
    ...
    --output-dir "artifacts/phase0_first_pretrain/h256_steps50000_seed1" `
    --append-md "experiments/Experiment 29 - First Local Pretrain/results_h256_steps50000_seed1.md"
