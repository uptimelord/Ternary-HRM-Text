...
VARIANT_SPECS = {
    "combo_baseline": None,
    "combo_2bit_attention_gqkv": "both_attention_gqkv",
    "combo_2bit_attention_o": "both_attention_o",
    "combo_2bit_attention": "both_attention",
}
...
def append_row(path: Path, row: dict, baseline_eval: float | None, baseline_packed: float | None, *, noise_floor: float) -> None:
...
def main() -> int:
    ...
    for seed in seeds:
        ...
        for variant in variants:
            ...
            if args.append_md is not None:
                append_row(args.append_md, row, baseline_eval, baseline_packed, noise_floor=noise_floor)
