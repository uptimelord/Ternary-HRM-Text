# Exp90.2 Prose To Lattice (seed 2)
...
- neural strict_pass@1: `0.270`
- exact strict_pass@1: `0.550`
- params: `8949890` | fp32_mb: `35.80`
- peak_vram_mb: `503.7` | elapsed_s: `712.3`

## examples
- `cl_train_easy_055993::vgr0` neural=False "Answer: Mia > Bob > Lily." exact=True "Answer: Mia > Lily > Bob."
- `cl_train_hard_006395::vgr0` neural=False "Answer: Dan > Joy > Kai > Mia." exact=False "Answer: Kai > Joy > Mia > Dan."
...
- `cl_train_hard_019596::vgr0` neural=False "Answer: Bob > Kai > Max > Tom." exact=False "Answer: Bob > Max > Kai > Tom."
- `cl_train_hard_034555::vgr0` neural=False "Answer: Kai > Ann > Dan > Joy > Leo > Mia." exact=False "Answer: Kai > Ann > Dan > Joy > Leo > Mia."
- `cl_train_easy_039426::vgr0` neural=False "Answer: Ben." exact=True "Answer: Dan."
- `cl_train_hard_000413::vgr0` neural=False "Answer: Kai." exact=True "Answer: Lily."
- `cl_train_hard_032635::vgr0` neural=False "Answer: Joy > Ann > Max > Mia > Ria > Lily." exact=False "Answer: Joy > Ann > Max > Mia > Ria > Lily."
