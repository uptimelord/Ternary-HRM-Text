...
& rtk python -u "experiments/Experiment 33 - EqR Lite Recurrence Stability/eqr_lite_recurrence_sft.py" `
    ...
    --ri-z-l-std 0.10 `
    --sot-segments 3 `
    --sot-segment-h-cycles 2 `
    --generation-eval-limit 0 `
    --generation-max-new-tokens 64 `
    --output-dir "artifacts/phase0_eqr_lite_recurrence/h256_exp33_2_sot_from_exp30pilot_d015_zl010_seg2x3_steps2000_seed1" `
    --append-md "experiments/Experiment 33 - EqR Lite Recurrence Stability/results_h256_exp33_2_sot_from_exp30pilot_d015_zl010_seg2x3_steps2000_seed1.md"
