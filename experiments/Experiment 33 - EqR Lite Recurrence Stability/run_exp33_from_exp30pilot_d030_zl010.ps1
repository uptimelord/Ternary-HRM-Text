...
& rtk python -u "experiments/Experiment 33 - EqR Lite Recurrence Stability/eqr_lite_recurrence_sft.py" `
    ...
    --output-dir "artifacts/phase0_eqr_lite_recurrence/h256_exp33_from_exp30pilot_d030_zl010_steps2000_seed1" `
    --append-md "experiments/Experiment 33 - EqR Lite Recurrence Stability/results_h256_exp33_from_exp30pilot_d030_zl010_steps2000_seed1.md"
