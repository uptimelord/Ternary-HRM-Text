...
& rtk python -u "experiments/Experiment 33 - EqR Lite Recurrence Stability/eqr_lite_recurrence_sft.py" `
    ...
    --output-dir "artifacts/phase0_eqr_lite_recurrence/h256_exp33_4_from_exp30pilot_d015_zl010_h246_steps10000_eval200_h246" `
    --append-md "experiments/Experiment 33 - EqR Lite Recurrence Stability/results_h256_exp33_4_from_exp30pilot_d015_zl010_h246_steps10000_eval200_h246.md"
