...
& rtk python -u "experiments/Experiment 33.6 - EqR Convergence Probe/eqr_convergence_probe.py" `
    ...
    --residual-batches 64 `
    --output-dir "artifacts/phase0_eqr_convergence_probe/h256_exp34_1_seed2pretrain_sftseed1_bp4_residual_only_h246" `
    --append-md "experiments/Experiment 33.6 - EqR Convergence Probe/results_h256_exp34_1_seed2pretrain_sftseed1_bp4_residual_only_h246.md"
