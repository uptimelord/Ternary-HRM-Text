...
- schema_exact@1: `0.365`
- semantic_schema_exact@1: `0.365`
- raw_solver_verified@1: `0.540`
- repaired_solver_verified@1: `0.540`
- oracle_solver_verified@1: `1.000`
- solver_verified@1: `0.540` raw compatibility alias
...
- peak_vram_mb: `563.0`
- elapsed_s: `130.7`
- checkpoint: `artifacts\exp93e_routed_trm_field_head_messy_all_pairspan_probe\checkpoint.pt`
...
| arithmetic | 1.000 | 0.460 | 0.460 | 0.460 | 0.460 | 1.000 |
| maze | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 |
| logic_rules | 1.000 | 0.000 | 0.000 | 0.700 | 0.700 | 1.000 |

## Component Metrics

| component | pass@1 |
|---|---:|
| arithmetic.a@1 | 0.940 |
| arithmetic.b@1 | 0.940 |
| arithmetic.domain@1 | 1.000 |
| arithmetic.operands@1 | 0.940 |
| arithmetic.operator@1 | 0.460 |
| comparative_order.dimension@1 | 0.940 |
| comparative_order.domain@1 | 1.000 |
| comparative_order.objects_order@1 | 0.020 |
| comparative_order.objects_set@1 | 0.880 |
