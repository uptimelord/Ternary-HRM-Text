...
- vocab size: `57`
- eval domain counts: `{'comparative_order': 50, 'arithmetic': 0, 'maze': 0, 'logic_rules': 0}`
...
- train loss: `0.1284`
- params: `146560`
- ternary params: `142912`
- ternary param fraction: `0.975`
- fp32_mb: `0.56`
- packed_mb: `0.05`
- packed exact: `True`
- peak_vram_mb: `186.4`
- elapsed_s: `90.3`
- checkpoint: `artifacts\exp93e_exp831_pointer_v2_comparative_order_1k_seed1\checkpoint.pt`

## Per Domain

| domain | format_valid@1 | schema_exact@1 | solver_verified@1 |
|---|---:|---:|---:|
| comparative_order | 1.000 | 0.000 | 0.000 |
...
| component | pass@1 |
|---|---:|
| comparative_order.dimension@1 | 0.980 |
...
rel=$1>$3
rel=$3>$3`
- `mds_heldout_comparative_order_000001_abb549ba` `comparative_order` score=`{'format_valid': True, 'json_valid': True, 'domain_match': True, 'schema_exact': False, 'solver_verified': False}`
  - target: `@comparative_order
dimension=score
query=full_order
object=$3
