...
- format_valid@1: `0.890`
- json_valid@1: `0.890`
- domain_match@1: `0.890`
- schema_exact@1: `0.325`
- solver_verified@1: `0.325`
- train loss: `0.1907`
- params: `149376`
...
- peak_vram_mb: `187.4`
- elapsed_s: `320.5`
- checkpoint: `artifacts\exp93e_exp831_pointer_v2_seed1\checkpoint.pt`

## Per Domain

| domain | format_valid@1 | schema_exact@1 | solver_verified@1 |
|---|---:|---:|---:|
| comparative_order | 0.820 | 0.000 | 0.000 |
| arithmetic | 1.000 | 0.300 | 0.300 |
| maze | 1.000 | 1.000 | 1.000 |
| logic_rules | 0.740 | 0.000 | 0.000 |
