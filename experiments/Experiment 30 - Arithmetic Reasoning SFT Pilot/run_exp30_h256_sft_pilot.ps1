...
& rtk python -m experiments.discipline preflight-readme `
    "experiments/Experiment 30 - Arithmetic Reasoning SFT Pilot/README.md"
...
& rtk python -u "experiments/Experiment 30 - Arithmetic Reasoning SFT Pilot/arithmetic_sft_pilot.py" `
    ...
    --output-dir "artifacts/phase0_arithmetic_sft_pilot/h256_steps2000_seed1" `
    --append-md "experiments/Experiment 30 - Arithmetic Reasoning SFT Pilot/results_h256_steps2000_seed1.md"
