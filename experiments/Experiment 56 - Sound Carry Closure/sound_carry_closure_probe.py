...
Exp55 had the carry lattice, but the solver could still return arithmetically
impossible singleton states because neural thresholding was the only eliminator.

Exp56 adds the missing sound operator:
- after neural thresholding, close the lattice under column carry equations
- after branch pinning, close again
- if any cell becomes empty, conflict/abstain
